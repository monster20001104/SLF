...
class Netrx_Info_Data(BasePacket):
    name = 'netrx_info_data'
    fields_desc = [
        BitField("vq", 0, 10),
...
class Netrx_Alloc_Slot_Rsp_Data(BasePacket):
    name = 'netrx_alloc_slot_rsp_dat'
    fields_desc = [
        BitField("qid", 0, 10),
        BitField("pkt_id", 0, 10),
        BitField("ok", 0, 1),
...
class RdDataRspSbd(BasePacket):
    name = "rd_data_rsp_sbd"
    fields_desc = [
        BitField("vq", 0, 10),
        BitField("pkt_len", 0, 18),
    ]
